//esto solo va a ejecutarse cuando se llegue al . (final del archivo)
//la sintaxis dirige la generacion de codigo
...
public class GeneradorDeCodigo {
    ...
    private int topeMemoria; //-> arranca en 1792 (con el bloque fijo) y va subiendo con el programa en pl0
    private String nombre;
    private DataOutputStream bwe;
    private IndicadorDeErrores indicadorErrores;
    private String nombreArchivo;

    public GeneradorDeCodigo(String nomArchivo, IndicadorDeErrores indicErrores, String nombreArchivo) {
        this.memoria = new byte[MEM];
        this.nombre = nomArchivo;
        this.bwe = null;
        this.indicadorErrores = indicadorErrores;
        this.nombreArchivo = nombreArchivo.substring(0, nombreArchivo.length() - 3) + "exe"; //esto tiene que recortar el .pl0 para poner .exe al final del string
        cargarBloqueFijo();
        this.topeMemoria = 1792;
    }

    public void cargarByte(int b){ //con este metodo se pueden poner todas las instrucciones de la pag 26
        memoria[topeMemoria] = (byte) b;
        topeMemoria++;
    }

    public void cargarInt(int e){ //primero parsear la cadena de aLex a numero, y luego usar este metodo
        for(int i = 0; i < 4; i++) {
            cargarByte(e & 0xFF);
            e = e >> 8;
        }
    ...
    public void cargarIntEn(int e, int pos){
        for(int i = 0; i < 4; i++) {
            cargarByteEn(e & 0xFF, pos);
            pos++;
            e = e >> 8;
        }
    }
    ...
    private void cargarBloqueFijo(){ //header y E/S
        memoria[0] = (byte) 0x4D;
        memoria[1] = (byte) 0x5A;
        memoria[2] = (byte) 0x60;
        memoria[3] = (byte) 0x1;
        ...
        memoria[204] = (byte) 0x0; //Base of code
        ...
        memoria[212] = (byte) 0x0; //Image Base
        memoria[213] = (byte) 0x0;
        memoria[214] = (byte) 0x40;
        memoria[215] = (byte) 0x0; //hasta aca, contienen
